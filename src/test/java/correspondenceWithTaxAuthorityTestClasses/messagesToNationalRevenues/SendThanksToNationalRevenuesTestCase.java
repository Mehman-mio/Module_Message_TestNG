...
public class SendThanksToNationalRevenuesTestCase extends BaseTest {
    ...
    public void messageWritingPageTest(){
        ...
        messageWritingPage_taxAuthorityNationalRevenues.thanksWritingPageMethods_TaxAuthority();
    }
