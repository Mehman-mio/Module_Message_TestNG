...
public class SendLetterToNationalRevenuesTestCase extends BaseTest {
    ...
    public void messageWritingPageTest(){
        ...
        messageWritingPage_taxAuthorityNationalRevenues.letterWritingPageMethods_TaxAuthority();
    }
